...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	if(ID.equals("admin")){
	%>
	<input type="button" class="btn btn-default navbar-btn" name="update" id="update" value="회원정보 관리">
	<input type="button" class="btn btn-default navbar-btn" name="logout" value="로그아웃" onClick="window.location='logoutConfirm.jsp'"/>
	<%
	}else{
	%>
